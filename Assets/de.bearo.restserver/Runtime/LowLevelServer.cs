...
namespace RestServer {
    public class LowLevelServer : WsServer {
        ...
        public Endpoint? FindEndpoint(HttpMethod? method, string absoluteUrl) {
            _logger.Log($"FindEndpoint for {method} and {absoluteUrl}.");
            return !method.HasValue ? null : _endpointCollection.FindEndpoint(method.Value, absoluteUrl);
        }

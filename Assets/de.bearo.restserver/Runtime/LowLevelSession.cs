...
namespace RestServer {
    public class LowLevelSession : WsSession {
        ...
        protected override void OnReceivedRequest(HttpRequest request) {
...
#if RESTSERVER_PROFILING && ENABLE_PROFILER
            ...
            var requestAndResponse = new RestRequest(this, request, Response, requestUri, DebugLog, responseLog, redirectHelper);
        ...
        protected virtual void OnReceivedRequestExecuteHandler(HttpRequest request, LowLevelServer server, Uri requestUri, RestRequest requestAndResponse) {
            ...
            while (true) {
                var endpoint = server.FindEndpoint(HttpMethodFrom(request.Method), endpointPath);
        ...
        protected override void OnReceivedRequestHeader(HttpRequest request) {
            ...
            var requestUri = GetRequestUri(request);
            var endpointPath = requestUri.AbsolutePath;
            Endpoint = server.FindEndpoint(HttpMethodFrom(request.Method), endpointPath);

            var allowUpgrade = Endpoint.HasValue && Endpoint.Value.WebSocketUpgradeAllowed;
        ...
        private RestRequest CreateWsTinyRequestAndResponse(HttpRequest request) {
            ...
            var responseLog = new RestRequestResponseLog();
            var requestAndResponse = new RestRequest(this, request, Response, requestUri, DebugLog, responseLog, null);
        ...
        public override void OnWsConnected(HttpRequest request) {
            ...
            var server = Server as LowLevelServer;
            if (Endpoint.HasValue) {
                server.RegisterWsSession(Endpoint.Value.WsEndpointId, this);
            }
        }
        ...
        public override void OnWsDisconnected() {
            ...
            var server = Server as LowLevelServer;
            if (Endpoint.HasValue) {
                server.DeregisterWsSession(Endpoint.Value.WsEndpointId, this);
            }
        }
        ...
        public override void OnWsReceived(byte[] buffer, long offset, long size) {
            ...
            if (Endpoint.HasValue) {
                try {
                    Endpoint.Value.WebSocketFrameHandler(new WebsocketMessage(buffer, this));    
                }catch (Exception e) {

...
namespace RestServer.Inspector {
    ...
    public class RestServerInspector : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            // 
            _foldoutConnection = EditorGUILayout.BeginFoldoutHeaderGroup(_foldoutConnection, $"Connection Properties [{rs.ListenAddress}:{GetRestServerPort(rs)}]");
            ...
            // Access Log
            // 
            if (EditorGUILayout.Toggle("Access Log", rs.SpecialHandlers.AccessLog == DefaultRequestHandlerImpl.DebugLogAccessLog)) {
                rs.SpecialHandlers.AccessLog = DefaultRequestHandlerImpl.DebugLogAccessLog;
            }
            else {
                rs.SpecialHandlers.AccessLog = DefaultRequestHandlerImpl.NoOpAccessLog;
            }
